...
function renderReport(p){
  ...
  <script>(function(){
    ...
    if(a) a.addEventListener('click', function(){
      doShare(location.href, 'report', '우리 아기 사주 스케치북', '곧 만날 우리 아기의 타고난 결을 담은 스케치북이에요.'); });
    var b=document.getElementById('shCopy');
    if(b) b.addEventListener('click', function(){ tb('report_share_click',{kind:'report'}); copy(location.href, 'report'); });
