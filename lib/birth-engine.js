...
function analyzeParent(pc){
  ...
  return { dayPillar:TG[dayTG]+pc.dayBranch, dayEl:pc.dayEl, level, yong, hee, sipseongTop:top, sipseongSub:_sub, branchSipseong:brSS, branchSipseong10:brSS10, dist, arche, trait, love, watch, recharge };
}
